...
export class Options {
  ...
  async loadVars(symbolArg = 'BTCUSDT') {
    ...
    if (!symbol) throw new Error(`${NULLKEY}:${RKEYS.SYMBOL}`);
    this._symbol = symbol;
